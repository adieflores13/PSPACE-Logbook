// app/homescreen/add_aircraft.tsx
    ...
    <ScreenLayout>
      ...
      >
        ...
        <View style={styles.card}>
          <View style={styles.engineRow}>
            ...
            <View style={styles.toggleGroup}>
              {(["single", "multi"] as const).map((opt) => (
                <TouchableOpacity
                  key={opt}
                  style={[styles.toggleButton, numberOfEngines === opt && styles.toggleButtonActive]}
                  onPress={() => setNumberOfEngines(opt)}
                >
                  <Text style={[styles.toggleText, numberOfEngines === opt && styles.toggleTextActive]}>
                    {opt === "single" ? "Single Engine" : "Multi Engine"}
                  </Text>
                </TouchableOpacity>
              ))}
            </View>
          ...
          <View style={styles.engineRow}>
            <Text style={styles.label}>Maximum Takeoff Weight (MTOW):</Text>
            <TextInput
...
const styles = StyleSheet.create({
  ...
  backButton: { alignSelf: "flex-start", marginBottom: 8, padding: 4 },
  ...
  card: {
    ...
    shadowColor: Colors.shadow, shadowOpacity: 0.07,
  ...
  label: { fontSize: 13, fontWeight: "600", color: Colors.textPrimary, width: 110 },
  input: {
    flex: 1, fontSize: 13, color: Colors.textPrimary,
    borderBottomWidth: 1, borderBottomColor: Colors.border,
    paddingVertical: 2, paddingHorizontal: 4,
  },
  engineRow: { paddingVertical: 12 },
  toggleGroup: { flexDirection: "row", flexWrap: "wrap", marginTop: 10, gap: 6 },
  toggleButton: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 8, backgroundColor: Colors.toggleInactive },
  toggleButtonActive: { backgroundColor: Colors.toggleActiveBackground },
  toggleText: { fontSize: 12, color: Colors.toggleInactiveText, fontWeight: "500" },
  toggleTextActive: { color: Colors.toggleActiveText, fontWeight: "600" },
  mtowInput: {
    fontSize: 13, color: Colors.textPrimary, marginTop: 10,
    borderBottomWidth: 1, borderBottomColor: Colors.border,
    paddingVertical: 4, paddingHorizontal: 4,
  },
  buttonRow: { flexDirection: "row", justifyContent: "center", gap: 16, marginTop: 8 },
  addButton: {
    backgroundColor: Colors.primary, paddingVertical: 15, paddingHorizontal: 36,
    borderRadius: 30, shadowColor: Colors.primary,
    shadowOpacity: 0.4, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 5,
  },
  addButtonText: { color: "#fff", fontWeight: "700", fontSize: 15 },
  cancelButton: { backgroundColor: Colors.cancelButton, paddingVertical: 15, paddingHorizontal: 36, borderRadius: 30 },
  cancelButtonText: { color: Colors.cancelText, fontWeight: "600", fontSize: 15 },
});